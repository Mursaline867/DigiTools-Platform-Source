    ...
    <section id="cta" className="bg-brand-gradient py-16 sm:py-20">
      <div className="container-shell text-center text-white">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <a href="#products" className="btn min-h-0 h-12 rounded-xl border-0 bg-white px-7 text-sm font-bold normal-case text-brand shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-white/90 active:translate-y-0 active:scale-[0.97] active:bg-white/90">Explore Products</a>
          <a href="#pricing" className="btn min-h-0 h-12 rounded-xl border border-white/50 bg-transparent px-7 text-sm font-bold normal-case text-white transition duration-300 hover:-translate-y-0.5 hover:border-white hover:bg-white/10 active:translate-y-0 active:scale-[0.97] active:border-white active:bg-white/15">View Pricing</a>
        </div>
